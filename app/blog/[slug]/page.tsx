      ...
      <article className="max-w-4xl mx-auto px-4 py-16">
        ...
        <header className="mb-12">
          ...
          <div className="text-gray-600 text-sm">
            <time>📅 {new Date(post.date).toLocaleDateString('pt-BR', { day: '2-digit', month: 'long', year: 'numeric' })}</time>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          <div className="prose prose-lg max-w-none">
            {/* A LINHA ABAIXO É O SEGREDO: 
                O @ts-ignore dentro de chaves força o TypeScript a ignorar o erro do MDXRemote 
            */}
            {/* @ts-ignore */}
